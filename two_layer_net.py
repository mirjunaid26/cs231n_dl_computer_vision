...
class TwoLayerNet(object):
    ...
    def loss(self, X, y=None, reg=0.0):
        ...
        # dscores = da2 (activation of layer 2 output was "identity" effectively)
        # scores = a1 * W2 + b2
    ...
    def train(self, X, y, X_val, y_val,
        ...
        - y_val: A numpy array of shape (N_val,) containing validation labels.
        - learning_rate: Scalar giving learning rate for optimization.
        - learning_rate_decay: Scalar giving factor to use for decaying the learning
          rate after each epoch.
        - reg: Scalar giving regularization strength.
        - num_iters: Number of iterations to take when optimizing.
